...
"$BT/apksigner" sign --ks test/debug.keystore --ks-pass pass:android \
    ...
    --out "out/ETC-APK-工坊-v2.29.apk" out/build/aligned.apk

echo ""
echo "== 验证 =="
"$BT/apksigner" verify --print-certs "out/ETC-APK-工坊-v2.29.apk" | head -3
"$BT/aapt2" dump badging "out/ETC-APK-工坊-v2.29.apk" | head -3
ls -la "out/ETC-APK-工坊-v2.29.apk"
echo "BUILD OK"
