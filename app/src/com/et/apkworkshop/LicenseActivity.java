...
public class LicenseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 标题
        TextView title = Ui.label(this, "ET APK 工坊 - 使用许可协议", Ui.PRIMARY, 20, true);
    ...
    private String getLicenseText() {
        return "【重要声明】请仔细阅读以下协议，使用本软件即表示您完全同意。\n\n"
                + "一、软件性质\n"
                + "ET APK 工坊（以下简称\"本软件\"）是一款安卓 APK 反编译、修改与重打包工具，由 ET 开发。"
                ...
                + "均由您本人自行承担，开发者 ET 不承担任何直接或间接责任。\n"
                + "3. 开发者 ET 不对本软件的适用性、可靠性、完整性做任何明示或暗示的担保。"
                ...
                + "本软件为免费工具，版权归 ET 所有，保留所有权利。\n"
                + "3. 禁止去除或修改本软件中的版权声明、作者信息及本协议内容。\n"
                + "4. 禁止将本软件用于任何违反当地法律法规的用途。\n\n"
                + "四、脱壳与加固说明\n"
                + "本软件内置的脱壳功能为静态提取方案，仅能提取未完全加密的 dex 文件。"
                + "对于动态加密的加固壳，需要在 root 设备上运行时内存转储，本软件不提供该功能。"
                + "脱壳后的文件仅供分析学习使用。\n\n"
                + "五、隐私说明\n"
                + "本软件不会收集您的任何个人信息。AI 对话内容仅发送至您在设置中自行配置的 AI 接口，"
                + "开发者 ET 无法获取或存储您的对话内容。\n\n"
                + "六、协议变更\n"
                + "开发者 ET 保留随时修改本协议的权利。修改后的协议将在软件更新时提示，"
                + "继续使用即表示同意修改后的协议。\n\n"
                + "七、联系方式\n"
